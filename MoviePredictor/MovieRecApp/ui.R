...
shinyUI(fluidPage(
  ...
  fluidRow(
    ...
    column(4, h3("Select some genres (more than one may be needed for obscure genres):"),
           wellPanel(
    ...
    column(4, h3("Select a movie from that genre (more than one may be needed for obscure movies):"),
           wellPanel(
